  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <p>There are several important laws and provisions within the 
          ...
          These laws serve as the foundation for governance and provide safeguards for the well-being and rights of citizens.</p>
